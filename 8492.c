...
int
fn (const float srintensity, const float rintensity, const float scale,
    const float rc, const float gc, const float bc, const int width,
    uint8_t * bptr, uint8_t * gptr, uint8_t * rptr, const float sgintensity,
    const float bintensity, const float sbintensity, const float gintensity)
{
