...
int
fn (const ptrdiff_t stride, int i, int u, int t, const int lim_q1,
    const int alpha, const int filter_q1, const int lim_p1,
    const int lim_p0q0, const uint8_t * cm, const int beta, int diff,
