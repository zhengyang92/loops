...
int
fn (uint8_t new_cfhd_vlc_len[528], int16_t new_cfhd_vlc_level[528],
    const uint8_t table_9_vlc_len[74], int i, uint32_t new_cfhd_vlc_bits[528],
    const uint32_t table_9_vlc_bits[74], const uint16_t table_9_vlc_run[74],
    int j, const uint8_t table_9_vlc_level[74],
