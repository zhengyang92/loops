...
int
fn (int i, uint16_t * out, const int fill_color, const int w,
    const uint64_t max, const int depth, const uint16_t * indata,
    const int off_y, const int inlinesize, const uint64_t add,
