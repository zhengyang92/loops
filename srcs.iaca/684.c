...
fn (const int stepw, int y, int sv, const uint8_t * in_uptr,
    const int thres_v, int yy, int su, const int chroma_w, const int w,
    const int thres_y, const int cy, const uint8_t * in_vptr,
    const uint8_t * in_yptr, const int cv, const int thres_u, const int cu,
