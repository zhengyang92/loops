...
int
fn (const uint16_t * c2, float delta, const uint16_t * c1, int x,
    const uint16_t * c6, float scale, const uint16_t * c0, int peak,
    const uint16_t * c8, const uint16_t * c7, int width, const uint16_t * c5,
