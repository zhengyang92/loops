...
int
fn (const ptrdiff_t stride, const int beta, int i, int u, int t,
    const int lim_q1, const int lim_p0q0, const int filter_q1,
    const int alpha, const int lim_p1, const uint8_t * cm, int diff,
    uint8_t * src, const int filter_p1, const int step)
{
