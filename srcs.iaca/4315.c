...
fn (const int stepw, const uint16_t * in_vptr, int sv, int y,
    const int thres_v, const uint16_t * in_uptr, int yy, int su,
    const int thres_y, const int w, const int chroma_w, const int cy,
    const int cv, const uint16_t * in_yptr, const int thres_u, const int cu,
