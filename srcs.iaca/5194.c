...
int
fn (int16_t * blocks, const uint8_t * scan, int run_cb, int i, int max_coeffs,
    int idx, int *error, const uint8_t ff_prores_run_to_cb_index[16],
    int abs_level, int level, int lev_cb, const int16_t * qmat,
