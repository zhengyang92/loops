...
int
fn (const int stepw, const uint16_t * in_vptr, int y, int sv,
    const uint16_t * in_uptr, int yy, int su, const int w, const int thres_y,
    const int chroma_w, const int cy, const int cv, const uint16_t * in_yptr,
    const int thres, const int thres_u, const int cu, const int sizew,
    const int thres_v)
{
  int cn = 1;
  int x = 0;
