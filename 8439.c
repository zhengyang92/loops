...
int
fn (uint16_t * ptr, const uint8_t roffset, const int step, const float mix,
    const float preserve, const int depth, const uint8_t goffset,
    const int width, const uint8_t boffset, const float *color)
{
