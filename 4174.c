...
fn (const uint16_t * yuv2, const int uv_offset, int w, const uint16_t * yuv0,
    const int rnd, int x, int crv, int16_t * rgb0, int cgu, int16_t * rgb1,
    const int sh, int16_t * rgb2, int cgv, int cy, const int16_t * yuv_offset,
    int cbu, const uint16_t * yuv1)
{
  for (x = 0; x < w; x++)
    {
