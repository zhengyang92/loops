...
int
fn (uint8_t new_cfhd_vlc_len[528], int i, uint32_t new_cfhd_vlc_bits[528],
    const uint16_t table_18_vlc_run[264], const uint8_t table_18_vlc_len[264],
    int j, const uint32_t table_18_vlc_bits[264],
    const uint8_t table_18_vlc_level[264], int16_t new_cfhd_vlc_level[528],
