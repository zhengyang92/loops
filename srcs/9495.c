...
int
fn (int16_t * blocks, int run_cb, int i, int max_coeffs, int idx,
    const uint8_t ff_prores_run_to_cb_index[16],
    const uint8_t ff_prores_ac_codebook[7], int abs_level, int level,
    const int16_t * qmat, int lev_cb, PutBitContext * pb,
    const uint8_t * scan, const uint8_t ff_prores_lev_to_cb_index[10],
    int run)
{
