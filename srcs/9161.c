...
int
fn (int i, uint8_t new_dv_vlc_run[818], const uint8_t ff_dv_vlc_level[409],
    uint16_t new_dv_vlc_bits[818], const uint8_t ff_dv_vlc_len[409], int j,
    const uint16_t ff_dv_vlc_bits[409], uint8_t new_dv_vlc_len[818],
