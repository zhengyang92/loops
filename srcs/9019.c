...
{ AV_CODEC_ID_NONE, AV_CODEC_ID_MPEG1VIDEO, AV_CODEC_ID_MPEG2VIDEO,
    ...
    AV_CODEC_ID_IFF_ILBM, AV_CODEC_ID_IFF_BYTERUN1, AV_CODEC_ID_KGV1,
    ...
    AV_CODEC_ID_MXPEG, AV_CODEC_ID_LAGARITH, AV_CODEC_ID_PRORES,
    AV_CODEC_ID_JV, AV_CODEC_ID_DFA, AV_CODEC_ID_WMV3IMAGE,
    AV_CODEC_ID_VC1IMAGE, AV_CODEC_ID_UTVIDEO, AV_CODEC_ID_BMV_VIDEO,
    AV_CODEC_ID_VBLE, AV_CODEC_ID_DXTORY, AV_CODEC_ID_V410, AV_CODEC_ID_XWD,
    AV_CODEC_ID_CDXL, AV_CODEC_ID_XBM, AV_CODEC_ID_ZEROCODEC,
    ...
    AV_CODEC_ID_ESCAPE130, AV_CODEC_ID_G2M, AV_CODEC_ID_WEBP,
    AV_CODEC_ID_HNM4_VIDEO, AV_CODEC_ID_HEVC, AV_CODEC_ID_FIC,
    ...
    AV_CODEC_ID_SCREENPRESSO, AV_CODEC_ID_RSCC, AV_CODEC_ID_MAGICYUV,
    AV_CODEC_ID_TRUEMOTION2RT, AV_CODEC_ID_AV1, AV_CODEC_ID_PIXLET,
    AV_CODEC_ID_CFHD, AV_CODEC_ID_FMVC, AV_CODEC_ID_CLEARVIDEO,
    ...
    AV_CODEC_ID_ADPCM_IMA_APC, AV_CODEC_ID_ADPCM_VIMA, AV_CODEC_ID_AMR_NB =
    0x12000, AV_CODEC_ID_AMR_WB, AV_CODEC_ID_RA_144 =
    0x13000, AV_CODEC_ID_RA_288, AV_CODEC_ID_ROQ_DPCM =
    0x14000, AV_CODEC_ID_INTERPLAY_DPCM, AV_CODEC_ID_XAN_DPCM,
    AV_CODEC_ID_SOL_DPCM, AV_CODEC_ID_MP2 =
    ...
    AV_CODEC_ID_FIRST_SUBTITLE = 0x17000, AV_CODEC_ID_DVD_SUBTITLE =
    ...
    AV_CODEC_ID_DVB_TELETEXT, AV_CODEC_ID_SRT, AV_CODEC_ID_FIRST_UNKNOWN =
    0x18000, AV_CODEC_ID_TTF = 0x18000, AV_CODEC_ID_PROBE =
    0x19000, AV_CODEC_ID_MPEG2TS = 0x20000, AV_CODEC_ID_MPEG4SYSTEMS =
    0x20001, AV_CODEC_ID_FFMETADATA = 0x21000, AV_CODEC_ID_WRAPPED_AVFRAME =
    0x21001, };
...
fn (enum AVPixelFormat pix_fmt, enum AVCodecID codec_id, int i,
    struct fmt_map fmt_conversion_table[16])
{
  for (i = 0;
       i <
