...
int
fn (float h13, float hs12, float h10, float hs11, float hs01, float h01,
    float (*r)[2], int len, float h02, float hs03, float hs10, float (*l)[2],
    float hs13, float h00, float h11, float hs02, int n, float h03,
