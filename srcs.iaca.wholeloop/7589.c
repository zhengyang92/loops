...
fn (uint16_t * const d1, const uint16_t * c0_data, const uint16_t * c2_data,
    ...
    const int slicew_end, const int d1_signed_linesize,
    const int slicew_start, const int limit, const int c2_shift_w,
    uint16_t * const d0, const int d2_signed_linesize, const int c1_shift_w,
    const uint16_t * c1_data, uint16_t * const d2)
{
