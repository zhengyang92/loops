...
int
fn (enum AVCodecID avcodec, const struct fmt_conversion fmt_map[39], int i,
    uint32_t v4l2_fmt)
{
  IACA_START for (i = 0; i < (sizeof (fmt_map) / sizeof ((fmt_map)[0])); i++)
    {
