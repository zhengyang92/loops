...
int
fn (int z1, int tmp10, int tmp13, int tmp0, int tmp4, int tmp7, int tmp2,
    int tmp1, int16_t * dataptr, int tmp6, int tmp11, int tmp5, int tmp3,
    int tmp12, int ctr)
{
  IACA_START for (ctr = 8 - 1; ctr >= 0; ctr--)
    {
