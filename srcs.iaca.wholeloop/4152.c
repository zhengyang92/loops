...
int
fn (double a1, int *clippings, double dry, double a0, const int32_t * ibuf,
    double out, double m2, double wet, double a2, double b0, int len,
    double m0, double b1, double m1, int32_t * obuf, int disabled)
{
