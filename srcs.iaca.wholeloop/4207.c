...
fn (int cvv, int w, const int rnd, int cyv, int y_off_in, int cyu,
    uint16_t * dst2, int cuv, int y_off_out, int x, const int sh,
    const uint16_t * src2, uint16_t * dst0, const ptrdiff_t *src_stride,
    int cuu, const ptrdiff_t *dst_stride, int cvu, uint16_t * dst1,
