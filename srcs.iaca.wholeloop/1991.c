...
int
fn (const ptrdiff_t mb_stride, uint8_t * fixed, int mb_y,
    int blocklist_length, int mb_x, int mb_height, int (*blocklist)[2],
    const int mb_width)
{
  IACA_START for (mb_x = 0; mb_x < mb_width; mb_x++)
    {
