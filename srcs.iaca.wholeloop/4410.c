...
int
fn (int i, uint8_t * dst_color, int int_y1, int int_x1, int src_linestep,
    int int_y, int frac_y, int src_linesize, int frac_x, const uint8_t * src,
    int int_x)
{
  IACA_START for (i = 0; i < src_linestep; i++)
    {
