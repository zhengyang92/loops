...
int
fn (int64_t dt, int i, int64_t ts3, int64_t ts2, int32_t f, int r, int32_t a,
    int32_t cpoints[7][2], struct ws_intervals *inter, int64_t ts1,
    int64_t ts4)
{
  IACA_START for (i = 0; i < (sizeof (cpoints) / sizeof ((cpoints)[0])); i++)
    {
      ts4 =
	((ts2) >
