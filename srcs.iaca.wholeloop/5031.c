...
int
fn (ptrdiff_t dstep, const int16_t * src0, int i, int16_t * dst0,
    struct FFIIRFilterState *s, const struct FFIIRFilterCoeffs *c,
    ptrdiff_t sstep, int size)
{
  IACA_START for (i = 0; i < size; i += 4)
    {
      float in, res;
      in =
