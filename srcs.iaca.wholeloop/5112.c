...
int
fn (unsigned int s2, unsigned int t3, int i, unsigned int s3, unsigned int t0,
    unsigned int s1, unsigned int t1, unsigned int s0, int *win,
    unsigned int tmp[18], unsigned int t2, int *out, int *buf,
    const int icos36h[9], int j, const int icos36[9])
{
