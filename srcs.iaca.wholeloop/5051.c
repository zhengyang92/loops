...
int
fn (int t1, int row2, const uint8_t * flags, const int32_t * in, int i,
    int t6, int t4, int row4, int t8, int t5, int t7, int16_t * out, int row8,
    int t0, int t3, ptrdiff_t pitch, int t2)
{
