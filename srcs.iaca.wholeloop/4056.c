...
int
fn (TXSample t3, const TXSample * wim, TXComplex * z, TXSample t4,
    TXSample t6, TXSample t5, const TXSample * cos, TXSample t1, TXSample r1,
    int o3, int o1, int len, TXSample t2, TXSample i0, int o2, TXSample r0,
    TXSample i1)
{
  IACA_START for (int i = 0; i < len; i += 4)
    {
      do
	{
	  do
