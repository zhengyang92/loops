...
fn (const int c1_shift_h, int y, const int c1_linesize,
    const uint8_t * c1_data, const int dst_linesize, const int c0_shift_w,
    int x, const uint8_t * c0_data, uint8_t * dst_data,
    const int dst_signed_linesize, const int src_h, const int c0_shift_h,
