...
int
fn (uint16_t * d1_data, const uint16_t * c0_data, const int mid,
    const uint16_t * c2_data, const int src_w, uint16_t * d2_data,
    const int c0_shift_w, int x, const int limit, const int c2_shift_w,
    uint16_t * d0_data, const int c1_shift_w, const uint16_t * c1_data,
    const int max, const int intensity)
{
