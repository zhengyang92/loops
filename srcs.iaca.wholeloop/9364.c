...
int
fn (uint8_t * ptr, int p4, int ql, int i, const ptrdiff_t b_stride, int p0,
    int p2, int p5, int p6, int t, int quant, int p9, int p3, int p8,
    const ptrdiff_t a_stride, int p1, int p7)
{
  IACA_START for (i = 0; i < 8; i++, ptr += b_stride)
    {
      p0 = ptr[-5 * a_stride];
      p1 = ptr[-4 * a_stride];
      p2 = ptr[-3 * a_stride];
