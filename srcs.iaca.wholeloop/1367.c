...
int
fn (struct sbg_script *s, int i, struct ws_intervals *inter, void *log, int r,
    struct sbg_script_event *ev2, struct sbg_script_event ev0,
    struct sbg_script_event *ev1)
{
  IACA_START for (i = -1; i < s->nb_events; i++)
    {
