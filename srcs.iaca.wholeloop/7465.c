...
int
fn (const int stepw, int y, int sv, const int thres_v, int yy, int su,
    const int w, const int thres_y, const int chroma_w, const int cy,
    const uint8_t * in_yptr, const uint8_t * in_vptr, const int sizew,
    const int cv, const int thres_u, const int cu, const uint8_t * in_uptr,
    const int thres)
{
  int cn = 1;
  int x = 0;
