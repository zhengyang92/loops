...
int
fn (int mrefs, int w, int interpol, int spat, uint16_t * dst, int x,
    uint16_t * prev, int prefs, int mrefs2, uint16_t * next2, uint16_t * cur,
    int clip_max, uint16_t * next, uint16_t * prev2, int prefs2)
{
