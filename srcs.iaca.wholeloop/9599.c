...
int
fn (int adx, vorbis_floor1 * vf, int dy, int err, unsigned int range,
    uint16_t floor1_Y_final[258], int off, int floor1_flag[258],
    int predicted, unsigned int i, uint16_t floor1_Y[258], int ady)
{
  IACA_START for (i = 2; i < vf->x_list_dim; ++i)
    {
