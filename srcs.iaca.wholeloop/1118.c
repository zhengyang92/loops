...
fn (const int c1_shift_h, const int d0_signed_linesize,
    ...
    const int c2_linesize, const int c0_linesize, uint8_t * d2_data,
    const uint8_t * c1_data, const int d1_signed_linesize,
    const int d0_linesize, uint8_t * d0_data, const int d1_linesize,
    uint8_t * const d0, const int intensity)
{
