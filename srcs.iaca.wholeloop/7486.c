...
int
fn (const uint16_t * c2, float delta, const uint16_t * c1,
    const uint16_t * c0, int x, float scale, const uint16_t * c8, int peak,
    int width, const uint16_t * c7, const uint16_t * c6, const uint16_t * c5,
