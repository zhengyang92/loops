...
fn (uint16_t * const d1, const uint16_t * c0_data, const uint16_t * c2_data,
    const int d0_signed_linesize, const int slicew_end, int x,
    const int slicew_start, const int d1_signed_linesize,
    ...
    const uint16_t * c1_data, int intensity, const int max,
    uint16_t * const d2)
{
