...
fn (const int c1_shift_h, const uint16_t * c2_data,
    ...
    const int mid, const int c1_linesize, uint16_t * d2_data,
    const int c0_shift_w, int x, uint16_t * const d0, const int c2_shift_h,
    const int c1_shift_w, uint16_t * const d2, int y, const int src_h,
    const int c2_shift_w, uint16_t * d0_data, const int c0_shift_h,
    const int c2_linesize, const int c0_linesize, uint16_t * d1_data,
