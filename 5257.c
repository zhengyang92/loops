...
int
fn (int max_rate_categories[28], const uint8_t expected_bits_table[8], int i,
    int offset, int min_rate_categories[28], int *power_categories,
    int expected_number_of_code_bits, int number_of_regions, int region,
